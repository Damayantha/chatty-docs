...
export const navigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "LiveKit Voice Token",  href: "/api-reference/voice/token" },
      { title: "Inbox & Auto-Assign",  href: "/api-reference/inbox/manage" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Team & Permissions",   href: "/guides/team-permissions" },
