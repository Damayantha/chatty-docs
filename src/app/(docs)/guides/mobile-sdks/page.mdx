...
**Swift Package Manager.** In Xcode: **File → Add Package Dependencies**, paste the URL and select version `1.0.8`:
...
.package(url: "https://github.com/PersonaliAI/chatty-ios-sdk", from: "1.0.8")
```

Also available via CocoaPods: `pod 'ChattySDK', '~> 1.0.8'`.
